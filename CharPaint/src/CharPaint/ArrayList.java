...
/**
 * Implementation of an array list. In this implementation: - The list can be
 * resized. - No null values allowed.
 */
public class ArrayList<T> implements List<T>, Serializable {
	...
	/**
	 * Helper method to insert new element into the ArrayList
	 * 
	 * @param index
	 * @param obj
	 */
